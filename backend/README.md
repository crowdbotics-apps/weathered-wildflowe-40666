...
## Project Structure
    ...
    ├── weathered_wildflowe_40666  # Django project configurations
...
1. Clone this repo and `cd weathered_wildflowe_40666`
...
2. Clone this repo and `cd weathered_wildflowe_40666`
